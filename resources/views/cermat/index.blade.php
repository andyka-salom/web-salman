{{-- resources/views/cermat/reports/index.blade.php --}}
@extends('layouts.app')

@section('title', 'Daftar Laporan CeRMAT')

@push('styles')
    {{-- DataTable Assets --}}
    <link rel="stylesheet" href="{{ asset('plugins/src/table/datatable/datatables.css') }}">
    <link rel="stylesheet" href="{{ asset('plugins/css/light/table/datatable/dt-global_style.css') }}">
    <link rel="stylesheet" href="{{ asset('plugins/css/dark/table/datatable/dt-global_style.css') }}">
        ...
        <div class="col-12">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
                ...
                <div class="btn-action-group d-flex gap-2 align-items-center">
                    {{-- Export Button (Role Specific) --}}
                    @hasanyrole('super-admin|hsse|koordinator|rses')
                    ...
                    <a href="{{ route('cermat.reports.create') }}" class="btn btn-primary rounded-pill px-4 shadow-sm">
            ...
            <div class="alert alert-success alert-dismissible fade show shadow-sm mb-4" role="alert">
                <div class="d-flex align-items-center">
                    ...
                    <strong>Berhasil!</strong><span class="ms-1">{{ session('success') }}</span>
                </div>
            ...
            <div class="widget-content widget-content-area br-8 p-4">
                    ...
                    <ul class="nav nav-pills d-flex flex-nowrap flex-md-wrap gap-2" id="cermat-tabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#table-container" role="tab" data-scope="review">
                                ...
                                @if(isset($hssePendingCount) && $hssePendingCount > 0)
                                    <span class="badge bg-danger ms-2 rounded-pill px-2 py-1" style="font-size: 0.75rem;">
                                        {{ $hssePendingCount }}
                                    </span>
                                @endif
                        ...
                        {{-- 5. Tab Semua Data --}}
                        @hasanyrole('super-admin|hsse|rses|koordinator')
                        <li class="nav-item" role="presentation">
                ...
                {{-- Filter Section (Only visible for 'all' scope) --}}
                <div id="filter-section" class="mb-4" style="display: none;">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <div class="row g-3">
                                {{-- Filter Company --}}
                                @hasanyrole('super-admin|hsse|rses')
                                <div class="col-md-4">
...
<div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('cermat.reports.export') }}" method="GET">
