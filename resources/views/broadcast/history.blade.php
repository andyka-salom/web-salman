...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        {{-- Filter Section (Menggunakan gaya filter-section) --}}
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="filter-section">
                ...
                <form method="GET" action="{{ route('broadcast.history') }}">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <select class="form-select" name="status" id="status">
                                ...
                                @foreach(['draft', 'scheduled', 'processing', 'sending', 'completed', 'failed', 'cancelled'] as $status)
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <select class="form-select" name="target_type" id="target_type">
                                ...
                                @foreach(['manual', 'group_contact'] as $type)
                        ...
                        <div class="col-lg-4 col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="search" id="search" value="{{ request('search') }}" placeholder="Ketik kata kunci...">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-4 d-flex align-items-end">
                            <div class="d-grid gap-2 d-flex w-100">
                                ...
                                <a href="{{ route('broadcast.history') }}" class="btn btn-outline-secondary flex-grow-1" title="Reset Filter">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="fw-bold text-dark" title="{{ $broadcast->title }}">
                                                {{ Str::limit($broadcast->title ?? 'Tanpa Judul', 40) }}
                                            </span>
                                    ...
                                    <td>
                                        <span class="badge {{ $targetBadgeClass }}">
                                            ...
                                            @endif
                                            {{ ucwords(str_replace('_', ' ', $broadcast->target_type)) }}
                                        </span>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            {{-- Sent Count --}}
                                            <span class="fw-bold {{ $broadcast->failed_count > 0 ? 'text-warning' : 'text-success' }}">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            @if ($broadcast->scheduled_at)
                                                ...
                                                <span style="font-size: 13px;">{{ $broadcast->scheduled_at->format('d M Y, H:i') }}</span>
                                            @else
                                                <small class="text-muted">Dibuat:</small>
                                                <span style="font-size: 13px;">{{ $broadcast->created_at->format('d M Y, H:i') }}</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('broadcast.show', $broadcast->id) }}" class="btn btn-sm btn-outline-info" data-bs-toggle="tooltip" title="Lihat Detail">
