@extends('layouts.app')
@section('title', 'Hierarchy Diagram')
        ...
        <div class="row layout-top-spacing mb-4">
            <div class="col-12 d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('entity-functions.index') }}" class="btn btn-dark">Back</a>
                </div>
            </div>
        </div>
            ...
            <div class="tree-view-container" id="viewport">
                <div class="tree-canvas" id="canvas">
                    <div class="tree" id="treeRoot">
                        ...
                        <ul>
                            @foreach($nodes->whereNull('parent_id') as $root)
                            <li>
                                <div class="tree-node root-node">
                                    <span class="node-code text-primary">{{ $root->code }}</span>
                                    <span class="node-title text-primary">{{ $root->name }}</span>
                                    <span class="node-users">{{ $root->users_count }} Users</span>
                                </div>
                                {{ renderTree($root->id, $nodes) }}
                            </li>
                            @endforeach
                        </ul>
                    </div>
