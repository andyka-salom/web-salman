{{-- resources/views/entity-functions/partials/actions.blade.php --}}
<div class="d-flex align-items-center justify-content-end gap-1">

    {{-- View Details --}}
    <a href="{{ route('entity-functions.show', $entityFunction) }}"
    ...
    {{-- Edit --}}
    <a href="{{ route('entity-functions.edit', $entityFunction) }}"
    ...
    <button type="button"
            ...
            data-url="{{ route('entity-functions.destroy', $entityFunction) }}"
            data-bs-toggle="tooltip"
            title="Delete">
