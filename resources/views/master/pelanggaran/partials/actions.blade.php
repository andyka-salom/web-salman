{{-- resources/views/pelanggaran/partials/actions.blade.php --}}
<div class="d-flex align-items-center justify-content-end gap-1">

    {{-- View Details --}}
    <a href="{{ route('pelanggaran.show', $pelanggaran) }}"
    ...
    {{-- Edit --}}
    <a href="{{ route('pelanggaran.edit', $pelanggaran) }}"
    ...
    <button type="button"
            ...
            data-url="{{ route('pelanggaran.destroy', $pelanggaran) }}"
            data-bs-toggle="tooltip"
            title="Delete">
