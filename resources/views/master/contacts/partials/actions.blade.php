{{-- resources/views/master/contacts/partials/actions.blade.php --}}
<div class="d-flex justify-content-center gap-1">
    ...
    {{-- Toggle Status --}}
    <button type="button"
            class="btn btn-sm {{ $c->is_active ? 'btn-outline-warning' : 'btn-outline-success' }} toggle-status"
            style="width:30px;height:30px;padding:0;display:inline-flex;align-items:center;justify-content:center;border-radius:6px;"
            data-url="{{ route('contacts.toggle-status', $c) }}"
    ...
    <button type="button"
            ...
            style="width:30px;height:30px;padding:0;display:inline-flex;align-items:center;justify-content:center;border-radius:6px;"
            data-url="{{ route('contacts.destroy', $c) }}"
            data-name="{{ e($c->name) }}"
            title="Hapus">
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
