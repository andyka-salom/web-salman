    ...
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0 page-header-btn d-flex justify-content-md-end gap-2 flex-wrap">
                <a href="{{ route('contacts.import.form') }}" class="btn btn-outline-success">
        ...
        <div class="row mb-4">
            <div class="col-md-4 mb-3 mb-md-0">
                <div class="stat-card d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="stat-value" style="color:#716aca;">{{ number_format($stats['total']) }}</div>
            ...
            <div class="col-md-4 mb-3 mb-md-0">
                <div class="stat-card d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="stat-value" style="color:#00a86b;">{{ number_format($stats['active']) }}</div>
            ...
            <div class="col-md-4">
                <div class="stat-card d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="stat-value" style="color:#e74c3c;">{{ number_format($stats['inactive']) }}</div>
