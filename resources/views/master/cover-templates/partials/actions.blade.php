{{-- resources/views/cover_templates/partials/actions.blade.php --}}
<div class="d-flex align-items-center justify-content-end gap-1">

    {{-- View Details --}}
    <a href="{{ route('cover-templates.show', $coverTemplate) }}"
    ...
    {{-- Edit Template --}}
    <a href="{{ route('cover-templates.edit', $coverTemplate) }}"
    ...
    <button type="button"
            ...
            data-url="{{ route('cover-templates.destroy', $coverTemplate) }}"
            data-bs-toggle="tooltip"
