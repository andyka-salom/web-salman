...
@section('title', 'Security Event Categories Management')
    ...
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0 page-title-action">
                <a href="{{ route('security-event-categories.create') }}" class="btn btn-primary">
...
$(document).ready(function() {
    ...
    const table = $('#categories-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('security-event-categories.index') }}",
            data: function(d) {
