{{-- resources/views/security-event-categories/partials/actions.blade.php --}}
<div class="d-flex align-items-center justify-content-end gap-1">

    {{-- View Details --}}
    <a href="{{ route('security-event-categories.show', $category) }}"
    ...
    {{-- Edit Category --}}
    <a href="{{ route('security-event-categories.edit', $category) }}"
    ...
    {{-- Toggle Status --}}
    <button type="button"
            class="btn btn-sm {{ $category->is_active ? 'btn-outline-success' : 'btn-outline-secondary' }} toggle-status"
            data-url="{{ route('security-event-categories.toggle-status', $category) }}"
            data-bs-toggle="tooltip"
    ...
    <button type="button"
            ...
            data-url="{{ route('security-event-categories.destroy', $category) }}"
            data-bs-toggle="tooltip"
