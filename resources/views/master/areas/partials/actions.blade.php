{{-- resources/views/areas/partials/actions.blade.php --}}
<div class="d-flex align-items-center justify-content-end gap-1">
    ...
    {{-- Toggle Status --}}
    <button type="button"
            class="btn btn-sm {{ $area->is_active ? 'btn-outline-success' : 'btn-outline-secondary' }} toggle-status"
    ...
    <button type="button"
            ...
            data-url="{{ route('areas.destroy', $area) }}"
            data-bs-toggle="tooltip"
            title="Delete Area">
