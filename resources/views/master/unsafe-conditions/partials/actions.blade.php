{{-- resources/views/unsafe-conditions/partials/actions.blade.php --}}
<div class="d-flex align-items-center justify-content-end gap-1">

    {{-- View Details --}}
    <a href="{{ route('unsafe-conditions.show', $unsafeCondition) }}"
    ...
    {{-- Edit --}}
    <a href="{{ route('unsafe-conditions.edit', $unsafeCondition) }}"
    ...
    <button type="button"
            ...
            data-url="{{ route('unsafe-conditions.destroy', $unsafeCondition) }}"
            data-bs-toggle="tooltip"
            title="Delete">
