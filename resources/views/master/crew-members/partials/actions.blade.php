{{-- resources/views/crew-members/partials/actions.blade.php --}}
<div class="d-flex align-items-center justify-content-end gap-1">

    {{-- View Details --}}
    <a href="{{ route('crew-members.show', $crew) }}"
    ...
    {{-- Edit Crew Member --}}
    <a href="{{ route('crew-members.edit', $crew) }}"
    ...
    {{-- Toggle Status --}}
    <button type="button"
            class="btn btn-sm {{ $crew->is_active ? 'btn-outline-success' : 'btn-outline-secondary' }} toggle-status"
            data-url="{{ route('crew-members.toggle-status', $crew) }}"
            data-bs-toggle="tooltip"
            title="{{ $crew->is_active ? 'Deactivate' : 'Activate' }}">
        @if($crew->is_active)
    ...
    {{-- Delete Crew Member --}}
    <button type="button"
            class="btn btn-sm btn-outline-danger delete-crew"
            data-url="{{ route('crew-members.destroy', $crew) }}"
            data-name="{{ $crew->name }}"
            data-bs-toggle="tooltip"
