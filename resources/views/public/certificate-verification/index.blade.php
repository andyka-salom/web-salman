{{-- resources/views/public/certificate-verification/index.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
...
(function () {
    ...
    const VERIFY_URL = '{{ route("certificate-verification.verify") }}';
    const CSRF       = document.querySelector('meta[name="csrf-token"]').content;

    // ── Init captcha from server ──
    document.getElementById('captchaQuestion').textContent = '{{ $captcha["question"] }} = ?';
    document.getElementById('captchaExpected').value       = '{{ $captcha["payload"] }}';
