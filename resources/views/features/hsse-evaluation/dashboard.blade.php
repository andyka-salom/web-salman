@extends('layouts.app')
@section('title', 'HSSE Evaluation Dashboard')
    ...
    <div class="middle-content container-xxl p-0">
                ...
                <div class="dash-header-wrap">
                    <div class="row align-items-center g-3">
                        <div class="col-md-7">
                            ...
                            @if(!Auth::user()->hasAnyRole(['super-admin', 'hsse', 'user']))
                        ...
                        <div class="col-md-5">
                            <div class="dash-header-actions">
                                @if(Auth::user()->hasAnyRole(['super-admin', 'hsse', 'user']))
                                <a href="{{ route('hsse-evaluation.create') }}" class="btn-hdr btn-hdr-primary">
                                    <i class="bi bi-plus-lg"></i> Evaluasi Baru
                                </a>
                                @endif
                                <a href="{{ route('hsse-evaluation.index') }}" class="btn-hdr btn-hdr-ghost">
        ...
        <div class="filter-panel">
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="{{ Auth::user()->hasAnyRole(['super-admin','hsse']) ? 'col-xl-2 col-md-6' : 'col-xl-3 col-md-6' }}">
        ...
        <div class="kpi-grid">
            ...
            {{-- Kru Dievaluasi (dengan ratio bar) --}}
            <div class="kpi-card">
                ...
                {{-- Progress bar dievaluasi vs total aktif --}}
...
(function () {
    ...
    function loadDashboard() {
        ...
        fetch('{{ route("hsse-evaluation.dashboard-data") }}?' + getFilterParams().toString())
            .then(function(r) {
    ...
    function loadTop10() {
        ...
        fetch('{{ route("hsse-evaluation.top10-assessor") }}?' + getFilterParams().toString())
