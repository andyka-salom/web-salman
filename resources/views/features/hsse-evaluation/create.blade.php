@extends('layouts.app')
@section('title', 'Evaluasi On Board Kru')
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                        <div class="d-flex flex-column gap-4">
                            ...
                            {{-- SECTION 1: Identitas Kapal & Assessor --}}
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @else
                                                ...
                                                <input type="text" class="form-control bg-light"
                                                    value="{{ $userCompany->name ?? 'N/A' }}" readonly>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="vessel_select" class="form-select" required
                                                @hasrole('super-admin|hsse|user') disabled @endhasrole
                                                <option value="">— Pilih kapal —</option>
                                                @unlessrole('super-admin|hsse|user')
                                    ...
                                    <div class="mt-4 pt-3 border-top">
                                        ...
                                        <div class="dig-sig-preview">
                                            <div class="dig-sig-name" id="sig-name-preview">{{ auth()->user()->name }}</div>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div id="crew-panels-wrap">
                                        <div class="crew-panel active" id="crew-panel-0" data-crew-idx="0">
                                            @include('features.hsse-evaluation.partials.crew-panel-static', [
                                                'criteria' => $criteria,
                                                'idx'      => 0,
                                            ])
                                        </div>
                            ...
                            <div class="card shadow-sm border-0 br-8">
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <a href="{{ route('hsse-evaluation.index') }}" class="btn btn-light text-muted py-2">Batal</a>
                                    </div>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const TOTAL = {{ $criteria->count() }};
    const CLIST = @json($criteria->map(fn($c) => ['id'=>$c->id,'order_no'=>$c->order_no,'aspect'=>$c->aspect]));
    const STORE = '{{ route("hsse-evaluation.store") }}';
    const INDEX = '{{ route("hsse-evaluation.index") }}';
    ...
    function onCompanyChange(companyId) {
        ...
        fetch('{{ route("hsse-evaluation.vessels-by-company") }}?company_id=' + companyId)
            .then(r => r.json())
            .then(data => {
    ...
    function onVesselChange(vesselId) {
        ...
        fetch('{{ route("hsse-evaluation.crew-by-vessel") }}?vessel_id=' + vesselId)
