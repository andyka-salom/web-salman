@extends('layouts.app')
@section('title', 'Buat Laporan Campaign Salman')
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                @else
                                                    ...
                                                    <input type="text" class="form-control bg-light" value="{{ $userCompany->name ?? 'N/A' }}" readonly>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" id="template_select" name="cover_template_id" required>
                                                    ...
                                                    @foreach($templates as $t)
                                                        <option value="{{ $t->id }}"
                                                            {{ ($defaultTemplate && $t->id == $defaultTemplate->id) ? 'selected' : '' }}>
                                                            {{ $t->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="card shadow-sm border-0 br-8">
                                    <div class="card-body p-4 text-center">
                                        ...
                                        <div class="d-grid gap-2">
                                            ...
                                            <a href="{{ route('campaign-salman.index') }}" class="btn btn-outline-secondary py-2">Batal</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#createForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('campaign-salman.store') }}",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
