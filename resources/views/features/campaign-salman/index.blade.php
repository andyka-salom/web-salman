{{-- resources/views/features/campaign-salman/index.blade.php --}}
@extends('layouts.app')

@section('title', 'Campaign Salman Reports')
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <div class="page-action-buttons d-flex justify-content-md-end gap-2 flex-wrap">
                    ...
                    @endrole
                    <a href="{{ route('campaign-salman.create') }}" class="btn btn-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
{{-- ================================================================ --}}
{{-- MODALS — hanya untuk super-admin & hsse                          --}}
{{-- ================================================================ --}}
@role('super-admin|hsse')
...
<div id="export-loading-overlay">
    <div class="export-spinner-box">
        ...
        {{-- Progress bar (hanya tampil saat ZIP) --}}
...
(function ($) {
    ...
    var table = $('#campaign-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("campaign-salman.index") }}',
            data: function (d) {
    ...
    $('#btn_download_zip').on('click', function () {
        ...
        fetch('{{ route("campaign-salman.export-zip-check") }}', { method: 'POST', body: fd })
            ...
            .then(function (data) {
                ...
                fetch('{{ route("campaign-salman.export-zip") }}', { method: 'POST', body: fd2 })
                    .then(function (response) {
                        var ct = response.headers.get('Content-Type') || '';
                        if (ct.indexOf('application/json') !== -1) {
                            return response.json().then(function (json) {
    ...
    $('#btn_download_excel').on('click', function () {
        ...
        fetchDownload(
            '{{ route("campaign-salman.export-excel") }}',
            {
                start_date:         s,
                end_date:           e,
