...
<div class="d-flex align-items-center justify-content-end gap-1">
    ...
    <a href="<?php echo e(route('vessels.show', $vessel)); ?>"
    ...
    <a href="<?php echo e(route('vessels.edit', $vessel)); ?>"
    ...
    <button type="button"
            ...
            data-url="<?php echo e(route('vessels.destroy', $vessel)); ?>"
            data-name="<?php echo e($vessel->name); ?>"
            data-bs-toggle="tooltip"
            title="Delete Vessel">
...
<?php if (! $__env->hasRenderedOnce('58f2dc7c-37e5-49fd-99a8-e689761bdaac')): $__env->markAsRenderedOnce('58f2dc7c-37e5-49fd-99a8-e689761bdaac'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/kaptensa/salman/resources/views/master/vessels/partials/actions.blade.php ENDPATH**/ ?>