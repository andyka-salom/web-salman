...
<div class="d-flex align-items-center justify-content-end gap-1">
    ...
    <a href="<?php echo e(route('areas.show', $area)); ?>"
    ...
    <button type="button"
            class="btn btn-sm <?php echo e($area->is_active ? 'btn-outline-success' : 'btn-outline-secondary'); ?> toggle-status"
            data-url="<?php echo e(route('areas.toggle-status', $area)); ?>"
            data-bs-toggle="tooltip"
            title="<?php echo e($area->is_active ? 'Deactivate Area' : 'Activate Area'); ?>">
    ...
    <button type="button"
            ...
            data-url="<?php echo e(route('areas.destroy', $area)); ?>"
            data-bs-toggle="tooltip"
            title="Delete Area">
...
<?php if (! $__env->hasRenderedOnce('39d095e8-94c3-443b-9f61-39c5d4a66f5a')): $__env->markAsRenderedOnce('39d095e8-94c3-443b-9f61-39c5d4a66f5a'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/kaptensa/salman/resources/views/master/areas/partials/actions.blade.php ENDPATH**/ ?>