...
<div class="d-flex align-items-center justify-content-end gap-2">
    ...
    <div class="dropdown">
        <button class="btn btn-sm btn-light-dark text-dark dropdown-toggle dropdown-toggle-split"
                type="button"
                id="dropdownMenuButton<?php echo e($row->id); ?>"
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0"
            aria-labelledby="dropdownMenuButton<?php echo e($row->id); ?>"
            style="min-width: 200px;">

            
            <li>
                <a class="dropdown-item d-flex align-items-center py-2"
                   href="<?php echo e(route('campaign-salman.show', $row->id)); ?>">
            ...
            <li>
                <a class="dropdown-item d-flex align-items-center py-2"
                   href="<?php echo e(route('campaign-salman.edit', $row->id)); ?>">
            ...
            <li>
                <a class="dropdown-item d-flex align-items-center py-2"
                   href="<?php echo e(route('campaign-salman.preview', $row->id)); ?>"
                   target="_blank">
            ...
            <li>
                <a class="dropdown-item d-flex align-items-center py-2"
                   href="<?php echo e(route('campaign-salman.download', $row->id)); ?>">
            ...
            <li>
                <button type="button"
                        ...
                        data-url="<?php echo e(route('campaign-salman.destroy', $row->id)); ?>">
...
<?php if (! $__env->hasRenderedOnce('2e2e28db-e2d4-4029-a791-484d5ac0cf4c')): $__env->markAsRenderedOnce('2e2e28db-e2d4-4029-a791-484d5ac0cf4c'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/kaptensa/salman/resources/views/features/campaign-salman/partials/actions.blade.php ENDPATH**/ ?>