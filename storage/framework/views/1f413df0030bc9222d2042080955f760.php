...
<?php $__env->startSection('title', 'KPI HSSE Kontraktor'); ?>
    ...
    <div class="row layout-top-spacing mb-4 align-items-center">
        <div class="col-md-6">
            ...
            <p class="text-muted mb-0 small">
                <?php if($isKoord): ?> Kelola laporan KPI perusahaan Anda.
                <?php elseif($isSA): ?> Akses penuh semua laporan. Dapat edit &amp; hapus permanen.
                <?php else: ?> Laporan submitted, waiting review, dan validated.
                <?php endif; ?>
            </p>
        </div>
        <div class="col-md-6 text-md-end mt-3 mt-md-0 d-flex justify-content-md-end gap-2 flex-wrap align-items-center">
            <?php if($pendingReviewCount > 0 && $isHsse && !$isKoord): ?>
                <span class="pending-count-badge">
                    <i class="bi bi-clock-history"></i>
                    <?php echo e($pendingReviewCount); ?> menunggu review
                </span>
            <?php endif; ?>
            <a href="<?php echo e(route('kpi-hsse.dashboard')); ?>" class="btn btn-outline-info btn-sm">
                <i class="bi bi-speedometer2 me-1"></i> Dashboard
            </a>
            <?php if($isKoord || $isSA): ?>
                <a href="<?php echo e(route('kpi-hsse.create')); ?>" class="btn btn-primary btn-sm">
        ...
        <div class="row g-3 align-items-end">
            ...
            <div class="col-lg-3 col-md-4 col-6">
                ...
                <select class="form-select form-select-sm" id="filter_company">
                    ...
                    <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($c->id); ?>" <?php echo e(request('company_id') == $c->id ? 'selected' : ''); ?>>
                            <?php echo e($c->name); ?>
            ...
            <div class="col-lg-3 col-md-4 col-6">
                ...
                <select class="form-select form-select-sm" id="filter_period">
                    ...
                    <?php $__currentLoopData = $periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($p->period_month . '-' . $p->period_year); ?>"
                            <?php echo e(request('period') == $p->period_month . '-' . $p->period_year ? 'selected' : ''); ?>>
                            <?php echo e($p->label ?? $p->period_month . '/' . $p->period_year); ?>
            ...
            <div class="col-lg-3 col-md-4 col-6">
                ...
                <select class="form-select form-select-sm" id="filter_status">
                    ...
                    <option value="validated"  <?php echo e(request('status') === 'validated'  ? 'selected' : ''); ?>>Validated</option>
    ...
    <div class="table-responsive">
        <table id="kpiTable" class="table dt-table-hover" style="width:100%">
            <thead>
                <tr>
                    <th>No</th>
                    <?php if($isHsse): ?><th>Perusahaan</th><?php endif; ?>
                    <th>Periode</th>
                    <th>Kapal / Unit</th>
                    <th>Status</th>
            ...
            <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                ?>
                <tr>
                    <td><?php echo e($reports->firstItem() + $loop->index); ?></td>

                    <?php if($isHsse): ?>
                    <td>
                        <span class="fw-semibold" style="font-size:.83rem;"><?php echo e($r->company->name ?? '-'); ?></span>
                    </td>
                    <?php endif; ?>

                    <td>
                        <span class="fw-bold"><?php echo e($r->kpiPeriod->label ?? '-'); ?></span>
                    </td>

                    <td style="max-width:175px;font-size:.79rem;word-wrap:break-word;white-space:normal;">
                        <?php $__currentLoopData = $r->vessels->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <?php echo e($v->vessel_name); ?>

                                <?php if($v->vessel_count): ?>
                                    <span class="text-muted" style="font-size:.69rem;">(<?php echo e($v->vessel_count); ?>)</span>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if($r->vessels->count() > 2): ?>
                            <div class="text-muted" style="font-size:.72rem;">+<?php echo e($r->vessels->count() - 2); ?> lainnya</div>
                        <?php endif; ?>
                    </td>

                    <td>
                        <span class="badge-kpi badge-kpi-<?php echo e($r->status); ?>"><?php echo e(ucfirst($r->status)); ?></span>
                    ...
                    <td class="text-center">
                        <?php if($r->total_score): ?>
                            <span class="score-pill <?php echo e($scoreClass); ?>"><?php echo e(number_format($sc, 0)); ?></span>
                        <?php else: ?>
                    ...
                    <td class="text-center">
                        <?php if($evCount > 0): ?>
                            <span class="badge bg-info"><?php echo e($evCount); ?> file</span>
                    ...
                    <td style="font-size:.77rem;color:#6b7280;white-space:nowrap;">
                        <?php echo e($r->updated_at->diffForHumans()); ?>
                    ...
                    <td class="text-center">
                        <div class="d-flex gap-1 justify-content-center flex-wrap">
                            ...
                            <?php if($canEdit): ?>
                                <a href="<?php echo e(route('kpi-hsse.edit', $r)); ?>"
                            ...
                            <a href="<?php echo e(route('kpi-hsse.export-pdf', $r)); ?>"
                            ...
                            <a href="<?php echo e(route('kpi-hsse.export', $r)); ?>"
                               class="btn btn-sm btn-outline-success"
                               title="Export Excel">
                                <i class="bi bi-file-earmark-spreadsheet"></i>
                            </a>

                            <?php if($isSA || ($isKoord && $r->status === 'draft')): ?>
                                <button type="button"
                                        class="btn btn-sm btn-outline-danger delete-record"
                                        data-url="<?php echo e(route('kpi-hsse.destroy', $r)); ?>"
                                        data-label="<?php echo e($r->kpiPeriod->label ?? ''); ?> — <?php echo e($r->company->name ?? ''); ?>"
                                        title="Hapus">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
                    <td colspan="<?php echo e($isHsse ? 9 : 8); ?>" class="text-center text-muted py-5">
                        <div style="font-size:2rem;margin-bottom:.5rem;">📋</div>
                        Belum ada laporan KPI.
                        <?php if($isKoord || $isSA): ?>
                            <a href="<?php echo e(route('kpi-hsse.create')); ?>" class="d-block mt-2">+ Buat laporan pertama</a>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endif; ?>
...
(function ($) {
    ...
    $('#resetFilters').on('click', function () {
        window.location.href = '<?php echo e(route("kpi-hsse.index")); ?>';
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/kpi-hsse/index.blade.php ENDPATH**/ ?>