...
<?php $__env->startSection('title', 'Crew Management'); ?>
...
<link href="<?php echo e(asset('plugins/css/light/sweetalerts2/custom-sweetalert.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(asset('plugins/css/dark/sweetalerts2/custom-sweetalert.css')); ?>" rel="stylesheet" type="text/css" />
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <select class="form-select" id="positionFilter">
                            ...
                            <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <select class="form-select" id="healthCategoryFilter">
                            ...
                            <?php $__currentLoopData = $healthCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
function initializePage() {
    ...
    const table = $('#crew-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('crew.index')); ?>",
            data: function(d) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/crew/index.blade.php ENDPATH**/ ?>