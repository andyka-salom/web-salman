<?php $__env->startSection('title', 'Areas Management'); ?>
...
<style>
    ...
    .ts-wrapper.single .ts-control:after {
        right: 15px; /* Rapikan posisi panah dropdown */
    }
    .form-select {
        height: 48px;
    }
...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            <div class="col-md-6">
                <h3 class="m-0 fw-bold">Areas Management</h3>
            </div>
            ...
            <div class="filter-section">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <select id="companyFilter" placeholder="Select Company" autocomplete="off">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-8">
                <div class="table-responsive">
                    <table id="areas-table" class="table dt-table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th width="5%">No</th>
                                <th width="15%">Code</th>
...
$(document).ready(function() {
    // Tom Select Configuration - Plugin 'clear_button' dihapus untuk mencegah error
    ...
    $('#resetFilters').on('click', function() {
        $('#statusFilter').val('');
        // Kita clear TomSelect secara manual menggunakan API-nya
        companySelect.clear();
        table.draw();
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/areas/index.blade.php ENDPATH**/ ?>