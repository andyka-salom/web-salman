...
<head>
    ...
    <title>Error <?php echo e($statusCode ?? '404'); ?> | <?php echo e(config('app.name', 'Laravel')); ?></title>
    ...
    <link href="<?php echo e(asset('src/assets/css/light/pages/error/error.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('layouts/vertical-light-menu/css/dark/plugins.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('src/assets/css/dark/pages/error/error.css')); ?>" rel="stylesheet" type="text/css" />
...
<body class="error text-center">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 mr-auto mt-5 text-md-left text-center">
                <a href="<?php echo e(url('/')); ?>" class="ml-md-5">
                    <img alt="logo" src="<?php echo e(asset('src/assets/img/logo.svg')); ?>" class="dark-element theme-logo">
                    <img alt="logo" src="<?php echo e(asset('src/assets/img/logo2.svg')); ?>" class="light-element theme-logo">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid error-content">
        <div class="">
            <h1 class="error-number"><?php echo e($statusCode ?? '404'); ?></h1>
            <p class="mini-text"><?php echo e($errorTitle ?? $defaultTitle); ?></p>
            <p class="error-text mb-5 mt-1"><?php echo e($errorMessage ?? $message ?? $defaultMessage); ?></p>

            <?php if(($showImage ?? true)): ?>
                <img src="<?php echo e(asset('src/assets/img/error.svg')); ?>"
                     alt="Error <?php echo e($statusCode ?? '404'); ?>"
                     class="error-img"
                     onerror="this.style.display='none'">
            <?php endif; ?>

            <a href="<?php echo e($backUrl ?? url('/')); ?>" class="btn btn-dark mt-5">
                <?php echo e($backText ?? 'Go Back'); ?>

            </a>

            <?php if(($showHomeButton ?? false) && ($backUrl ?? url('/')) !== url('/')): ?>
                <a href="<?php echo e(url('/')); ?>" class="btn btn-outline-dark mt-5 ms-2">
                    Go Home
                </a>
            <?php endif; ?>
        </div>
...
<?php /**PATH /home/kaptensa/salman/resources/views/errors/http-error.blade.php ENDPATH**/ ?>