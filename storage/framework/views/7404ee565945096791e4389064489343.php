<?php $__env->startSection('title', 'Vessels & Crew Management'); ?>
                ...
                <div class="stats-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <h3 class="mb-0 fw-bold text-primary"><?php echo e($stats['total_vessels']); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="stats-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <h3 class="mb-0 fw-bold text-success"><?php echo e($stats['active_vessels']); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="stats-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <h3 class="mb-0 fw-bold text-info"><?php echo e($stats['total_crew']); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="stats-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <h3 class="mb-0 fw-bold text-warning"><?php echo e($stats['expiring_soon']); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    const table = $('#vessels-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('vessels.index')); ?>",
            data: function(d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/vessels/index.blade.php ENDPATH**/ ?>