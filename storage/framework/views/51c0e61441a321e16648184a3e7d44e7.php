<?php $__env->startSection('title', 'Unsafe Conditions Management'); ?>
...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            <div class="col-md-6">
                <h3 class="m-0 fw-bold">Unsafe Conditions</h3>
            </div>
            <div class="col-md-6 text-md-end mt-3 mt-md-0 page-title-action">
                <a href="<?php echo e(route('unsafe-conditions.create')); ?>" class="btn btn-primary">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-8">
                <div class="table-responsive">
                    <table id="conditions-table" class="table dt-table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th width="5%">No</th>
                                <th width="15%">Code</th>
...
$(document).ready(function() {
    ...
    const table = $('#conditions-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('unsafe-conditions.index')); ?>",
            data: function(d) {
        ...
        columns: [
            ...
            { data: 'usage_count', name: 'usage_count', className: 'text-center' },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/unsafe-conditions/index.blade.php ENDPATH**/ ?>