...
<div class="d-flex align-items-center justify-content-end gap-1">
    ...
    <a href="<?php echo e(route('security-event-categories.show', $category)); ?>"
    ...
    <a href="<?php echo e(route('security-event-categories.edit', $category)); ?>"
    ...
    <button type="button"
            class="btn btn-sm <?php echo e($category->is_active ? 'btn-outline-success' : 'btn-outline-secondary'); ?> toggle-status"
            data-url="<?php echo e(route('security-event-categories.toggle-status', $category)); ?>"
            data-bs-toggle="tooltip"
    ...
    <button type="button"
            ...
            data-url="<?php echo e(route('security-event-categories.destroy', $category)); ?>"
            data-bs-toggle="tooltip"
...
<?php if (! $__env->hasRenderedOnce('efefd0c9-5aa9-433c-b736-f2eca98b306a')): $__env->markAsRenderedOnce('efefd0c9-5aa9-433c-b736-f2eca98b306a'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/kaptensa/salman/resources/views/master/security-event-categories/partials/actions.blade.php ENDPATH**/ ?>