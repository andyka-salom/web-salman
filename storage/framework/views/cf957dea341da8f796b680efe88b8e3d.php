<?php $__env->startSection('title', 'Home - CERMAT Analytics'); ?>
    ...
    <div class="modern-container">
        ...
        <div class="actions-section">
            ...
            <div class="actions-grid">
                ...
                <a href="<?php echo e(route('cermat.reports.create')); ?>" class="action-card">
                ...
                <a href="<?php echo e(route('user.my-actions.index')); ?>" class="action-card">
                    <div class="action-card-header">
                ...
                <a href="<?php echo e(route('dashboard.analytics')); ?>" class="action-card">
                    <div class="action-card-header">
                ...
                <a href="<?php echo e(route('kpi-hsse.index')); ?>" class="action-card">
                    <div class="action-card-header">
                ...
                <a href="<?php echo e(route('daily-checkup.index')); ?>" class="action-card">
                    <div class="action-card-header">
                ...
                <a href="<?php echo e(route('campaign-salman.index')); ?>" class="action-card">
                    <div class="action-card-header">
                ...
                <a href="<?php echo e(route('broadcast.create.manual')); ?>" class="action-card">
                    <div class="action-card-header">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage vessels')): ?>
                <a href="<?php echo e(route('crew.index')); ?>" class="action-card">
                    <div class="action-card-header">
        ...
        <div class="features-section">
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view cermat dashboard')): ?>
                    <a href="<?php echo e(route('dashboard.analytics')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage kpi hsse')): ?>
                    <a href="<?php echo e(route('kpi-hsse.index')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage crew')): ?>
                    <a href="<?php echo e(route('crew.index')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <a href="<?php echo e(route('dashboard.health-check')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <a href="<?php echo e(route('cermat.action-monitoring.index')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage cermat')): ?>
                    <a href="<?php echo e(route('cermat.reports.index')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage campaigns')): ?>
                    <a href="<?php echo e(route('campaign-salman.index')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage daily checkup')): ?>
                    <a href="<?php echo e(route('daily-checkup.index')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage broadcast')): ?>
                    <a href="<?php echo e(route('broadcast.create.manual')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['manage companies', 'manage vessels', 'manage users'])): ?>
                    <a href="<?php echo e(route('companies.index')); ?>" class="feature-link">
                ...
                <div class="feature-card">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage my action')): ?>
                    <a href="<?php echo e(route('user.my-actions.index')); ?>" class="feature-link">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/home.blade.php ENDPATH**/ ?>