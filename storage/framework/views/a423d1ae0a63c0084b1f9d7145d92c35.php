...
<?php $__env->startSection('title', 'Broadcast ke Grup Kontak'); ?>

<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('plugins/src/filepond/filepond.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('plugins/src/filepond/FilePondPluginImagePreview.min.css')); ?>">
    <link href="<?php echo e(asset('plugins/css/light/filepond/custom-filepond.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('plugins/css/dark/filepond/custom-filepond.css')); ?>" rel="stylesheet" type="text/css" />
    <style>
...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        <form action="<?php echo e(route('broadcast.send.group-contact')); ?>" method="POST" enctype="multipart/form-data" id="broadcastForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="col-xl-5 col-lg-5 col-md-12 mb-4">
                    <div class="widget-content widget-content-area br-8 p-4 h-100">
                        ...
                        <div class="row g-2 mb-4">
                            <div class="col-3">
                                <label class="target-option-card <?php echo e(old('target_selection','group') == 'group' ? 'selected' : ''); ?>" for="select_group">
                                    <input class="form-check-input d-none" type="radio" name="target_selection" id="select_group" value="group"
                                           <?php echo e(old('target_selection','group') == 'group' ? 'checked' : ''); ?> onchange="toggleTarget('group')">
                            ...
                            <div class="col-3">
                                <label class="target-option-card <?php echo e(old('target_selection') == 'manual' ? 'selected' : ''); ?>" for="select_manual">
                                    <input class="form-check-input d-none" type="radio" name="target_selection" id="select_manual" value="manual"
                                           <?php echo e(old('target_selection') == 'manual' ? 'checked' : ''); ?> onchange="toggleTarget('manual')">
...
unset($__errorArgs, $__bag); ?>" id="group_id" name="group_id">
                                <option value="">-- Pilih Grup --</option>
                                <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($group->id); ?>" <?php echo e(old('group_id') == $group->id ? 'selected' : ''); ?>>
                                    <?php echo e($group->group_name); ?> (<?php echo e($group->member_count ?? 0); ?> anggota)
                                </option>
                            ...
                            <ul class="nav nav-tabs mb-3" id="contactTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#user-content" type="button" role="tab">
                                        Users
                                        <span class="tab-count-badge"><?php echo e($users->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#crew-content" type="button" role="tab">
                                        Crew
                                        <span class="tab-count-badge"><?php echo e($crewMembers->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#contact-content" type="button" role="tab">
                                        Contacts
                                        <span class="tab-count-badge" style="background:rgba(37,211,102,0.15);color:#25D366;"><?php echo e($contacts->count()); ?></span>
                                    </button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="contactTabContent">
                                ...
                                <div class="tab-pane fade show active" id="user-content" role="tabpanel">
                                    ...
                                    <div class="checkbox-list-scroll">
                                        ...
                                        <div class="form-check checkbox-item user-item" data-search="<?php echo e(strtolower($user->name . ' ' . $user->phone)); ?>">
                                            <input class="form-check-input manual-checkbox user-checkbox" type="checkbox"
                                                   name="user_ids[]" value="<?php echo e($user->id); ?>" id="user_<?php echo e($user->id); ?>"
                                                   <?php echo e(in_array($user->id, old('user_ids', [])) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="user_<?php echo e($user->id); ?>">
                                                <span class="fw-semibold d-block" style="font-size:13px;"><?php echo e($user->name); ?></span>
                                ...
                                <div class="tab-pane fade" id="crew-content" role="tabpanel">
                                    ...
                                    <div class="checkbox-list-scroll">
                                        <?php $__empty_1 = true; $__currentLoopData = $crewMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crew): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="form-check checkbox-item crew-item" data-search="<?php echo e(strtolower($crew->name . ' ' . $crew->phone)); ?>">
                                            <input class="form-check-input manual-checkbox crew-checkbox" type="checkbox"
                                                   name="crew_member_ids[]" value="<?php echo e($crew->id); ?>" id="crew_<?php echo e($crew->id); ?>"
                                                   <?php echo e(in_array($crew->id, old('crew_member_ids', [])) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="crew_<?php echo e($crew->id); ?>">
                                                <span class="fw-semibold d-block" style="font-size:13px;"><?php echo e($crew->name); ?></span>
                                                <small class="text-muted"><?php echo e($crew->phone); ?> · <?php echo e($crew->position ?? 'N/A'); ?></small>
                                            </label>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                ...
                                <div class="tab-pane fade" id="contact-content" role="tabpanel">
                                    ...
                                    <div class="checkbox-list-scroll">
                                        ...
                                        <div class="form-check checkbox-item contact-item"
                                             data-search="<?php echo e(strtolower($contact->name . ' ' . $contact->whatsapp_number . ' ' . ($contact->position ?? ''))); ?>">
                                            <input class="form-check-input manual-checkbox contact-checkbox" type="checkbox"
                                                   name="contact_ids[]" value="<?php echo e($contact->id); ?>" id="contact_<?php echo e($contact->id); ?>"
                                                   <?php echo e(in_array($contact->id, old('contact_ids', [])) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="contact_<?php echo e($contact->id); ?>">
                                                <span class="fw-semibold d-block" style="font-size:13px;"><?php echo e($contact->name); ?></span>
                                                <span class="wa-text d-flex align-items-center gap-1">
                                                    ...
                                                    <?php if($contact->position): ?> <small class="text-muted ms-1">· <?php echo e($contact->position); ?></small> <?php endif; ?>
                                                </span>
                                            </label>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
unset($__errorArgs, $__bag); ?>
                            <?php $__errorArgs = ['crew_member_ids'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="text-danger small mt-1"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      placeholder="Tulis pesan Anda di sini..." required><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                   id="scheduled_at" name="scheduled_at" value="<?php echo e(old('scheduled_at')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <a href="<?php echo e(route('broadcast.index')); ?>" class="btn btn-outline-secondary">Batal</a>
...
<script src="<?php echo e(asset('plugins/src/filepond/filepond.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/src/filepond/FilePondPluginFileValidateType.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/src/filepond/FilePondPluginImageExifOrientation.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/src/filepond/FilePondPluginImagePreview.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/src/filepond/filepondPluginFileValidateSize.min.js')); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/broadcast/create-group-contact.blade.php ENDPATH**/ ?>