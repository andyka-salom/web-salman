<?php $__env->startSection('title', 'Pelanggaran Management'); ?>
...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            <div class="col-md-6">
                <h3 class="m-0 fw-bold">Pelanggaran Management</h3>
            </div>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="filter-section">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <label for="severityFilter" class="form-label">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-8">
                <div class="table-responsive">
                    <table id="pelanggaran-table" class="table dt-table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th width="5%">No</th>
...
$(document).ready(function() {
    ...
    const table = $('#pelanggaran-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('pelanggaran.index')); ?>",
            data: function(d) {
        ...
        columns: [
            ...
            { data: 'name', name: 'name' },
            { data: 'severity', name: 'severity', className: 'text-center' },
    ...
    // Filter Logic
    $('#statusFilter, #severityFilter').on('change', function() { table.draw(); });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/pelanggaran/index.blade.php ENDPATH**/ ?>