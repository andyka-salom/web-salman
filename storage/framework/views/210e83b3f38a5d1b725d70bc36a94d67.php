<?php $__env->startSection('title', 'Vessel Detail - ' . $vessel->name); ?>
            ...
            <div class="col-12">
                <div class="vessel-header">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h3><?php echo e($vessel->name); ?></h3>
                            <div class="d-flex gap-2 flex-wrap">
                                <span class="badge badge-light-<?php echo e($vessel->status_color); ?> fs-6">
                                    <?php echo e(ucfirst(str_replace('_', ' ', $vessel->status))); ?>

                                </span>
                                <span class="badge badge-light-info fs-6"><?php echo e($vessel->type); ?></span>
                                <?php if($vessel->valid_until): ?>
                                    <?php
                                        $days = $vessel->getDaysUntilExpiry();
                                        $badgeColor = $days < 0 ? 'danger' : ($days <= 30 ? 'warning' : 'success');
                                    ?>
                                    <span class="badge badge-light-<?php echo e($badgeColor); ?> fs-6">
                                        <?php echo e($days < 0 ? 'Expired' : ($days <= 30 ? 'Expiring in '.$days.' days' : 'Valid until '.date('d M Y', strtotime($vessel->valid_until)))); ?>
                        ...
                        <div class="col-md-4 mt-3 mt-md-0">
                            <div class="d-flex gap-2 justify-content-md-end">
                                ...
                                <a href="<?php echo e(route('vessels.edit', $vessel)); ?>" class="btn btn-light btn-action">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                                    Edit
                                </a>
                                <a href="<?php echo e(route('vessels.index')); ?>" class="btn btn-light btn-action">
        ...
        <div class="row layout-spacing">
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="stats-card">
                    ...
                    <h3 class="mb-0 fw-bold text-primary"><?php echo e($currentCrewMembers->count()); ?></h3>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="stats-card">
                    ...
                    <h3 class="mb-0 fw-bold text-success"><?php echo e($currentCrewMembers->where('is_active', true)->count()); ?></h3>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="stats-card">
                    ...
                    <h3 class="mb-0 fw-bold text-warning"><?php echo e($currentCrewMembers->where('is_active', false)->count()); ?></h3>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="stats-card">
                    ...
                    <h3 class="mb-0 fw-bold text-info"><?php echo e($crewByPosition->count()); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="row layout-spacing">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-value"><?php echo e($vessel->name); ?></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-item">
                                <div class="info-label">Type</div>
                                <div class="info-value"><?php echo e($vessel->type); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-value"><?php echo e($vessel->company->name ?? '-'); ?></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-item">
                                <div class="info-label">Coordinator</div>
                                <div class="info-value"><?php echo e($vessel->coordinator->name ?? '-'); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-value">
                                    <?php if($vessel->valid_until): ?>
                                        <?php echo e($vessel->valid_until->format('d M Y')); ?>

                                        <?php if($vessel->getDaysUntilExpiry() !== null): ?>
                                            <br><small class="text-muted">(<?php echo e($vessel->getDaysUntilExpiry()); ?> days remaining)</small>
                                        <?php endif; ?>
                                    <?php else: ?>
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-value">
                                    <span class="badge badge-<?php echo e($vessel->is_active ? 'success' : 'danger'); ?>">
                                        <?php echo e($vessel->is_active ? 'Active' : 'Inactive'); ?>
            ...
            <div class="col-xl-6 col-lg-6 col-sm-12">
                <div class="info-card">
                    ...
                    <?php if($crewByPosition->count() > 0): ?>
                        <div class="position-summary">
                            <?php $__currentLoopData = $crewByPosition; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="position-chip">
                                    <strong><?php echo e($position ?? 'Unassigned'); ?>:</strong> <?php echo e($count); ?>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <strong><?php echo e($crewByPosition->count()); ?></strong>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="text-muted">Available Crew</span>
                            <strong class="text-success"><?php echo e($availableCrew->count()); ?></strong>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-muted">Assignment Rate</span>
                            <strong class="text-primary">
                                <?php echo e($currentCrewMembers->count() > 0 ? number_format(($currentCrewMembers->where('is_active', true)->count() / $currentCrewMembers->count()) * 100, 1) : 0); ?>%
                            </strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="info-card">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="mb-0">
                            ...
                            <span class="badge badge-primary ms-2"><?php echo e($currentCrewMembers->count()); ?></span>
                        </h5>
                    ...
                    <?php if($currentCrewMembers->count() > 0): ?>
                        <div class="row" id="crewList">
                            <?php $__currentLoopData = $currentCrewMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crew): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4" data-crew-id="<?php echo e($crew->id); ?>">
                                <div class="crew-card card">
                                    <div class="card-body">
                                        
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="crew-avatar bg-gradient-primary">
                                                <?php echo e(strtoupper(substr($crew->name, 0, 2))); ?>

                                            </div>
                                            <div class="ms-3 flex-grow-1">
                                                <h6 class="mb-1 fw-bold"><?php echo e($crew->name); ?></h6>
                                                <small class="text-muted"><?php echo e($crew->nik); ?></small>
                                                <?php if($crew->position): ?>
                                                    <div class="mt-2">
                                                        <span class="position-badge"><?php echo e($crew->position); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="crew-info-item">
                                            ...
                                            <small class="text-muted"><?php echo e($crew->phone); ?></small>
                                        </div>
                                        <?php endif; ?>

                                        
                                        <?php if($crew->currentVesselAssignment): ?>
                                        <div class="crew-info-item">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                            <small class="text-muted"><?php echo e($crew->currentVesselAssignment->assigned_at->format('d M Y')); ?></small>
                                        </div>

                                        
                                        <?php if($crew->assigned_by_user): ?>
                                        <div class="crew-info-item">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                            <small class="text-muted">By: <?php echo e($crew->assigned_by_user->name); ?></small>
                                        </div>
                                        <?php endif; ?>

                                        
                                        <?php if($crew->assignment_notes): ?>
                                        <div class="crew-info-item">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                                            <small class="text-muted"><?php echo e(Str::limit($crew->assignment_notes, 40)); ?></small>
                                        </div>
                                        <?php endif; ?>
                                        <?php endif; ?>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                                            <span class="badge badge-<?php echo e($crew->is_active ? 'success' : 'danger'); ?>">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    ...
                    Assign Crew to <?php echo e($vessel->name); ?>
                    ...
                    <?php if($availableCrew->count() > 0): ?>
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="crew_member_id" name="crew_member_id" required>
                                ...
                                <?php $__currentLoopData = $availableCrew; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crew): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($crew->id); ?>"
                                            data-position="<?php echo e($crew->position); ?>"
                                            data-phone="<?php echo e($crew->phone); ?>">
                                        <?php echo e($crew->name); ?> - <?php echo e($crew->nik); ?>

                                        <?php if($crew->position): ?> (<?php echo e($crew->position); ?>) <?php endif; ?>
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
$(document).ready(function() {
    ...
    const vesselId = '<?php echo e($vessel->id); ?>';
    let crewSelect = null;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/vessels/show.blade.php ENDPATH**/ ?>