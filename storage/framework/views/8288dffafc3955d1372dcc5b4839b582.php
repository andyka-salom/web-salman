...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            <div class="col-md-6">
                <h3 class="m-0 fw-bold">Groups Management</h3>
            </div>
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-8">
                <div class="table-responsive">
                    <table id="groups-table" class="table dt-table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th width="5%">No</th>
                                <th>Group Name</th>
...
$(document).ready(function() {
    ...
    const table = $('#groups-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('groups.index')); ?>",
            data: function(d) {
    ...
    $(document).on('click', '.delete-group', function(e) {
        ...
        const groupName = $(this).closest('tr').find('td:eq(1)').text();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    error: function() { Toast.fire({ icon: 'error', title: 'Error deleting group' }); }
                });
            }
        });
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/groups/index.blade.php ENDPATH**/ ?>