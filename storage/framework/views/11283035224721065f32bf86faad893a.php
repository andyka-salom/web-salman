                ...
                <div class="widget-content widget-content-area br-8 p-0 overflow-hidden">
                    ...
                    <div class="text-center px-4 pb-4" style="margin-top: -60px;">
                        <div class="avatar-wrapper mb-3">
                            <img src="<?php echo e($user->photo_path ? Storage::url($user->photo_path) : asset('assets/img/profile-3.jpg')); ?>"
                        ...
                        <h4 class="mb-1 fw-bold text-break" style="color: #1b2e4b;"><?php echo e($user->name); ?></h4>
                        <p class="text-muted mb-2" style="font-size: 14px;"><?php echo e($user->jabatan ?? 'No Job Title'); ?></p>
                        ...
                        <div class="row g-2 mb-4">
                            <div class="col-6">
                                <div class="stat-box p-3 rounded" style="background-color: #f1f5f9;">
                                    <h6 class="mb-1 fw-bold" style="color: #1b2e4b;"><?php echo e($user->failed_login_attempts); ?></h6>
                        ...
                        <div class="d-grid gap-2">
                            <a href="<?php echo e(route('users.edit', $user)); ?>" class="btn btn-primary" style="border-radius: 8px; padding: 10px;">
                                <i class="bi bi-pencil-square me-2"></i>Edit Profile
                            </a>
                            <a href="<?php echo e(route('users.index')); ?>" class="btn btn-outline-secondary" style="border-radius: 8px; padding: 10px;">
                            ...
                            <div class="detail-card p-3 rounded" style="background-color: #f8fafc; border-left: 3px solid #667eea;">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="fw-semibold text-break" style="color: #1b2e4b; font-size: 14px;"><?php echo e($user->email); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="detail-card p-3 rounded" style="background-color: #f8fafc; border-left: 3px solid #10b981;">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="fw-semibold" style="color: #1b2e4b; font-size: 14px;"><?php echo e($user->phone ?? '-'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="detail-card p-3 rounded" style="background-color: #f8fafc; border-left: 3px solid #f59e0b;">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="fw-semibold" style="color: #1b2e4b; font-size: 14px;"><?php echo e($user->company->name ?? '-'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="detail-card p-3 rounded" style="background-color: #f8fafc; border-left: 3px solid #8b5cf6;">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="fw-semibold" style="color: #1b2e4b; font-size: 14px;"><?php echo e($user->entityFunction->name ?? '-'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="fw-semibold" style="color: #1b2e4b; font-size: 14px;">
                                            <?php echo e($user->last_login_at ? $user->last_login_at->format('d M Y, H:i:s') : 'Never'); ?>
                            ...
                            <div class="detail-card p-3 rounded" style="background-color: #f8fafc; border-left: 3px solid #6366f1;">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="fw-semibold" style="color: #1b2e4b; font-size: 14px;"><?php echo e($user->last_login_ip ?? '-'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="badge" style="background-color: #fed7aa; color: #c2410c; padding: 4px 12px; border-radius: 12px; font-weight: 600;">
                                            <?php echo e($user->failed_login_attempts); ?> attempts
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="fw-bold" style="color: #dc2626; font-size: 14px;">
                                            <?php echo e($user->locked_until->format('d M Y, H:i:s')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/users/show.blade.php ENDPATH**/ ?>