<?php $__env->startSection('title', 'My Tasks & Action Items'); ?>
...
<div class="container-fluid">
    ...
    <div class="task-list-wrapper">
        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusKey => $statusName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="task-group <?php echo e($groupClass); ?>" data-status-key="<?php echo e($statusKey); ?>">
                <div class="task-group-header" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo e($slug); ?>">
                    <div class="header-title">
                        <?php echo e($statusName); ?>

                    </div>
                    <span class="header-badge" id="count-<?php echo e($slug); ?>"><?php echo e($items->count()); ?></span>
                </div>

                <div id="collapse-<?php echo e($slug); ?>" class="collapse show">
                    <div class="list-container" id="container-<?php echo e($slug); ?>">
                        <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php echo renderTaskRow($item); ?>

                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            
                        <?php endif; ?>
                    </div>
                    <div class="p-4 text-center text-muted empty-placeholder" id="empty-<?php echo e($slug); ?>" style="<?php echo e($items->count() > 0 ? 'display:none;' : ''); ?>">
                        ...
                        <div class="modal-left">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select id="m_status" name="status" class="form-select">
                                    <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        window.openTaskModal = function(el) {
            const id = $(el).data('id');
            const url = `<?php echo e(url('user/my-actions')); ?>/${id}/edit`;
            ...
            $.get(url, function(data) {
                ...
                const rUrl = `<?php echo e(url('cermat/reports')); ?>/${r.id}`;
                ...
                if(data.photos && data.photos.length > 0) {
                    ...
                    data.photos.forEach(p => {
                        const src = `<?php echo e(asset('storage')); ?>/${p.file_path}`;
                        $('#m_gallery').append(`
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: `<?php echo e(url('user/my-actions')); ?>/${id}`,
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
        ...
        window.deletePhoto = function(photoId, btn) {
            Swal.fire({
                ...
                if(res.isConfirmed) {
                    $.ajax({
                        url: `<?php echo e(url('user/my-actions/photos')); ?>/${photoId}`,
                        type: 'DELETE',
                        success: function() {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/user/my-actions-kanban.blade.php ENDPATH**/ ?>