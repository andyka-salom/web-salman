...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            <div class="col-md-6">
                <h3 class="m-0 fw-bold">Roles Management</h3>
            </div>
            ...
            <div class="filter-section">
                <div class="row g-3 align-items-end">
                    <div class="col-lg-4 col-md-6">
                        <label for="guardFilter" class="form-label">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shield me-1">
                                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
                            </svg>
                            Guard Name Filter
                        </label>
                        <select class="form-select" id="guardFilter">
                            <option value="">All Guards (web, api, etc.)</option>
...
$(document).ready(function() {
    ...
    // Filter Logic
    $('#guardFilter').on('change', function() { table.draw(); });
    $('#resetFilters').on('click', function() { $('#guardFilter').val(''); table.draw(); });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/roles/index.blade.php ENDPATH**/ ?>