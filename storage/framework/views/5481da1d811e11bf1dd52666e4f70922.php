<?php $__env->startSection('title', 'Dashboard Campaign Salman - CERMAT Analytics'); ?>
        ...
        <div class="col-12">
            <div class="d-flex flex-column flex-xl-row justify-content-between align-items-xl-center gap-3">
                ...
                <div class="filter-container d-flex flex-wrap gap-3 align-items-end">
                    ...
                    <?php if($entityFunctions->isNotEmpty()): ?>
                    <div class="filter-group">
                        ...
                        <select id="entity_function_id" class="form-select form-select-sm select2-entity" style="width: 220px;">
                            ...
                            <?php $__currentLoopData = $entityFunctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $function): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    function refreshDashboard() {
        ...
        // AJAX Request
        fetch('<?php echo e(route("dashboard.campaign-salman.data")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/dashboard/campaign-salman.blade.php ENDPATH**/ ?>