<?php $__env->startSection('title', 'HSSE On Board Evaluation'); ?>
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <div class="page-action-buttons d-flex justify-content-md-end gap-2 flex-wrap">
                    ...
                    <a href="<?php echo e(route('hsse-evaluation.dashboard')); ?>" class="btn btn-outline-secondary">
                    ...
                    <?php if($canManage): ?>
                    <a href="<?php echo e(route('hsse-evaluation.create')); ?>" class="btn btn-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2"
                             stroke-linecap="round" stroke-linejoin="round">
...
(function ($) {
    ...
    var table = $('#eval-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(route("hsse-evaluation.index")); ?>',
            data: function (d) {
    ...
    $('#btnExport').on('click', function () {
        ...
        window.location.href = '<?php echo e(route("hsse-evaluation.export-excel")); ?>?' + params.toString();
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/features/hsse-evaluation/index.blade.php ENDPATH**/ ?>