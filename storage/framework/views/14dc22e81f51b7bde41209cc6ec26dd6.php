                    ...
                    <form id="general-info-form" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column align-items-center mb-5">
                            <div class="profile-img-box">
                                <img id="profilePreview"
                                     src="<?php echo e($user->photo_path ? Storage::url($user->photo_path) : asset('assets/img/profile-3.jpg')); ?>"
                            ...
                            <h4 class="mt-3 mb-1" style="font-weight: 700;"><?php echo e($user->name); ?></h4>
                            <p class="text-primary mb-0" style="font-weight: 500;"><?php echo e($user->jabatan ?? 'No Job Title'); ?></p>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="jabatan" value="<?php echo e($user->jabatan); ?>" placeholder="e.g. Manager">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <input type="text" class="form-control" name="phone" value="<?php echo e($user->phone); ?>" placeholder="+62...">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="p-3 mb-4 rounded" style="background-color: #f9fbfd; border: 1px dashed #e0e6ed;">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo e($user->company->name ?? '-'); ?>" readonly>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label text-muted">Entity Function</label>
                                    <input type="text" class="form-control" value="<?php echo e($user->entityFunction->name ?? '-'); ?>" readonly>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 layout-spacing">
                ...
                <div class="widget-content widget-content-area mb-4">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span>Role</span>
                            <span class="fw-bold text-primary"><?php echo e($user->roles->pluck('name')->join(', ')); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span><?php echo e($user->last_login_at ? $user->last_login_at->diffForHumans() : 'Never'); ?></span>
                        </li>
                    </ul>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/profile.blade.php ENDPATH**/ ?>