...
<head>
    ...
    <title>Laporan CeRMAT <?php echo e($report->report_number); ?></title>
    <style>
        ...
        <tr>
            ...
            <td class="no-border text-center" width="50%" style="vertical-align: bottom;">
                <div style="font-weight: bold; font-size: 14pt; border-bottom: 2px solid #000; display: inline-block; padding: 0 10px 2px 10px;">
                    No: <?php echo e($report->report_number); ?>

                </div>
            </td>
            <td class="no-border text-right" width="25%" style="vertical-align: bottom;">
                <?php if($logoSrc): ?>
                    <img src="<?php echo e($logoSrc); ?>" style="height: 45px;" alt="Logo">
                <?php else: ?>
        ...
        <tr>
            ...
            <td class="col-33">
                ...
                <div style="padding: 6px;">
                    ...
                    <div class="text-box" style="min-height: 80px;"><?php echo nl2br(e(trim($report->details))); ?></div>
                </div>

                <!-- Nilai Kerugian -->
                <div style="padding: 6px; border-top: 1px dotted #ccc;">
                    <span class="label">Nilai Kerugian (Value of loss):</span>
                    <?php if($report->value_of_loss): ?>
                        USD <?php echo e(number_format($report->value_of_loss, 2)); ?>
                ...
                <table style="border-top: 1px solid #000;">
                    <tr>
                        <td class="no-border" width="50%" style="border-right: 1px dotted #ccc !important;">
                            ...
                            <?php echo e($report->area->name ?? '-'); ?>

                        </td>
                        <td class="no-border">
                            <span class="label">Detail (Area)/Nama Kapal:</span>
                            <?php echo e($report->location_details ?? '-'); ?>
                    ...
                    <tr>
                        <td class="no-border" style="border-top: 1px dotted #ccc !important; border-right: 1px dotted #ccc !important;">
                            ...
                            <?php echo e($report->report_datetime ? formatWita($report->report_datetime, 'd F Y') : '-'); ?>

                        </td>
                        <td class="no-border" style="border-top: 1px dotted #ccc !important;">
                            <span class="label">Jam (Time):</span>
                            <?php echo e($report->report_datetime ? formatWita($report->report_datetime, 'H:i') . ' WITA' : '-'); ?>
                ...
                <div style="padding: 6px; border-top: 1px solid #000; border-bottom: 1px solid #000;">
                    ...
                    <div class="text-box" style="min-height: 40px;"><?php echo nl2br(e(trim($report->immediate_action_taken))); ?></div>
                </div>

                <!-- STOP Card -->
                <div style="padding: 6px; border-bottom: 1px solid #000; background-color: #f9f9f9;">
                    <span class="text-bold">STOP Job Issued?</span> &nbsp;&nbsp;
                    [ <?php echo e($report->stop_card_issued ? 'X' : ' '); ?> ] Ya/Yes &nbsp;&nbsp;&nbsp; [ <?php echo e(!$report->stop_card_issued ? 'X' : ' '); ?> ] Tidak/No
                </div>
                ...
                <div style="padding: 6px; border-bottom: 1px solid #000;">
                    ...
                    <div style="margin-top: 4px;">
                        ...
                        <div style="padding-left: 8px; font-size: 8.5pt;">
                            <?php $__empty_1 = true; $__currentLoopData = $report->unsafeActs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> &bull; <?php echo e($act->description); ?><br> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?> <span class="italic text-small" style="color:#999">- None</span> <?php endif; ?>
                        </div>
                    </div>
                    <div style="margin-top: 6px;">
                        <span class="text-bold text-small">- Kondisi Tidak Aman (Unsafe Conditions):</span>
                        <div style="padding-left: 8px; font-size: 8.5pt;">
                            <?php $__empty_1 = true; $__currentLoopData = $report->unsafeConditions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cond): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> &bull; <?php echo e($cond->description); ?><br> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?> <span class="italic text-small" style="color:#999">- None</span> <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div style="padding: 6px;">
                    ...
                    <div class="text-box" style="min-height: 40px;"><?php echo nl2br(e(trim($report->suggestion_for_improvement))); ?></div>
                </div>
                ...
                <div class="bg-yellow" style="border-top: 2px solid #000; padding: 6px;">
                    ...
                    <table class="no-border">
                        <tr>
                            <td class="no-border" width="55%">Nama (Name): <strong><?php echo e($report->reporter->name ?? '-'); ?></strong></td>
                            <td class="no-border text-center" rowspan="3" style="width: 45%;">
                                ...
                                <?php if($report->reporter): ?>
                                    <div class="stamp-box stamp-reporter" style="margin: 0;">
                                        ...
                                        <?php echo e($report->reporter->name); ?><br>
                                        <span style="font-size: 6.5pt; color:#333;"><?php echo e($report->reporter->email ?? ''); ?></span><br>
                                        <?php echo e(formatWita($report->created_at, 'd/M/Y H:i')); ?> WITA
                                    </div>
                                <?php else: ?>
                        ...
                        <tr>
                            <td class="no-border">Fungsi (Entity): <?php echo e($report->reporter->entityFunction->name ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="no-border">Email: <?php echo e($report->reporter->email ?? '-'); ?></td>
                        </tr>
                    </table>
                        ...
                        <table class="no-border">
                            <tr>
                                ...
                                <td class="no-border text-center">
                                    Td. Tangan (Signature):
                                    <?php if($report->supervisor_approved_at && $report->lineSupervisor): ?>
                                        <div class="stamp-box">
                                            <strong>APPROVED</strong><br>
                                            <?php echo e($report->lineSupervisor->name); ?><br>
                                            <span style="font-size: 6.5pt; color:#333;"><?php echo e($report->lineSupervisor->email); ?></span><br>
                                            <?php echo e(formatWita($report->supervisor_approved_at, 'd/M/Y H:i')); ?> WITA
                                        </div>
                                    <?php else: ?>
                                        <div style="margin-top: 20px; border-bottom: 1px dotted #000;"></div>
                                    <?php endif; ?>
            ...
            <td class="col-33">
                    ...
                    <table class="no-border">
                        <tr>
                            <td class="no-border" width="50%">
                                <span class="chk-box"><?php echo e($report->event_type == 'hse' ? 'X' : ''); ?></span> HSE Event<br>
                                <span class="chk-box"><?php echo e($report->event_type == 'security' ? 'X' : ''); ?></span> Security Event
                            </td>
                            <td class="no-border">
                                Sec. Category:<br>
                                <?php echo e($report->securityEventCategory->name ?? '-'); ?>

                            </td>
                            <td class="no-border" style="background: #000; color: #fff; font-weight: bold; text-align: center; font-size: 8pt; vertical-align: middle;">
                                <?php echo e($report->is_limited_circulation ? 'LIMITED CIRCULATION' : 'GENERAL CIRCULATION'); ?>

                            </td>
                        </tr>
                        <tr>
                            <td class="no-border" colspan="3" style="padding-top: 5px;">
                                P-horse: <strong><?php echo e($report->synergi_register_no ?? '__________'); ?></strong>
                            </td>
                        </tr>
                    </table>
                </div>
                <div style="padding: 4px; border-bottom: 1px solid #000; background: #f9f9f9; font-size: 8.5pt;">
                    <span class="chk-box"><?php echo e($report->classification == 'positive_aspect' ? 'X' : ''); ?></span> Positive Aspect &nbsp;
                    <span class="chk-box"><?php echo e($report->classification == 'unsafe_condition' ? 'X' : ''); ?></span> Unsafe condition &nbsp;
                    <span class="chk-box"><?php echo e($report->classification == 'unsafe_action' ? 'X' : ''); ?></span> Unsafe Action &nbsp;
                    <span class="chk-box"><?php echo e($report->classification == 'near_miss' ? 'X' : ''); ?></span> Near Miss &nbsp;
                    <span class="chk-box"><?php echo e($report->classification == 'incident' ? 'X' : ''); ?></span> Incident
                </div>
                ...
                <table class="risk-table">
                    ...
                    <?php $__currentLoopData = ['people' => 'Manusia', 'environment' => 'Lingkungan', 'reputation' => 'Reputasi', 'asset' => 'Aset', 'public' => 'Publik']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $r = $getRisk('initial', $key); ?>
                        <tr>
                            <td><?php echo e($label); ?></td>
                            <td><?php echo e($r->real_severity ?? '-'); ?></td>
                            <td><?php echo e($r->potential_severity ?? '-'); ?></td>
                            <td><?php echo e($r->likelihood ?? '-'); ?></td>
                        </tr>
                ...
                <div style="padding: 6px; border-top: 1px solid #000; border-bottom: 1px solid #000;">
                    ...
                    <span style="display:block; margin-bottom: 3px;"><?php echo e($report->pelanggaran->name ?? '-'); ?></span>
                </div>

                <!-- COST TO BUSINESS -->
                <div style="padding: 6px; border-bottom: 1px solid #000;">
                    <span class="text-bold text-small">Cost to Business (USD):</span>
                    Actual: <strong><?php echo e($report->cost_to_business_actual ? number_format($report->cost_to_business_actual, 2) : '_______'); ?></strong>
                    &nbsp;&nbsp;
                    Pot.: <strong><?php echo e($report->cost_to_business_potential ? number_format($report->cost_to_business_potential, 2) : '_______'); ?></strong>
                </div>

                <!-- NOTIFICATION -->
                <div style="padding: 6px; border-bottom: 1px solid #000;">
                    <span class="text-bold text-small">Immediate notification to Line Management?</span>
                    &nbsp; [ <?php echo e($report->notified_line_management ? 'X' : ' '); ?> ] Yes [ <?php echo e(!$report->notified_line_management ? 'X' : ' '); ?> ] No
                </div>
                ...
                <div style="padding: 6px; border-bottom: 1px solid #000; min-height: 40px;">
                    ...
                    <div class="text-small text-box"><?php echo nl2br(e(trim($report->short_term_mitigation))); ?></div>
                </div>
                ...
                <table class="risk-table" style="border-bottom: 1px solid #000;">
                    ...
                    <?php $__currentLoopData = ['people' => 'Manusia', 'environment' => 'Lingkungan', 'reputation' => 'Reputasi', 'asset' => 'Aset']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $r = $getRisk('residual', $key); ?>
                        <tr>
                            <td><?php echo e($label); ?></td>
                            <td><?php echo e($r->potential_severity ?? '-'); ?></td>
                            <td><?php echo e($r->likelihood ?? '-'); ?></td>
                ...
                <div style="padding: 6px; border-bottom: 1px solid #000;">
                    <table class="no-border">
                        <tr>
                            ...
                            <td class="no-border">
                                Signature & Name (HSSE):
                                <?php if($report->hsse_reviewed_at && $report->hsseOfficer): ?>
                                    <div class="stamp-box" style="margin: 0; padding: 2px;">
                                        <strong>REVIEWED</strong><br>
                                        <?php echo e($report->hsseOfficer->name); ?><br>
                                        <span style="font-size: 6.5pt; color:#333;"><?php echo e($report->hsseOfficer->email); ?></span><br>
                                        <?php echo e(formatWita($report->hsse_reviewed_at, 'd/M/Y H:i')); ?> WITA
                                    </div>
                                <?php endif; ?>
                            </td>
                        </tr>
                ...
                <div style="padding: 6px; min-height: 100px;">
                    ...
                    <ul class="action-list">
                        <?php $__empty_1 = true; $__currentLoopData = $report->actionItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li>
                                <?php echo e($item->description); ?> -
                                <b><?php echo e($item->responsible->name ?? 'PIC'); ?></b> -
                                <?php echo e($item->target_date ? Carbon::parse($item->target_date)->format('d/m/y') : '-'); ?>
            ...
            <td class="col-33">
                ...
                <div style="padding: 6px; min-height: 280px; border-bottom: 1px solid #000; overflow: hidden;">
                    <div class="photo-frame" style="min-height: 260px;">
                        <?php if(count($evidenceImages) > 0): ?>
                            <?php $__currentLoopData = $evidenceImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img src="<?php echo e($img); ?>" alt="Evidence Photo">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                ...
                <div style="border-top: 1px solid #000; padding: 6px;">
                    ...
                    <div class="text-box" style="background: #fdfdfd; border: 1px dotted #ccc; padding: 4px; min-height: 50px;">
                        <?php if($report->status === 'closed' || $report->status === 'no_action_required'): ?>
                            <?php echo nl2br(e(trim($report->close_out_description))); ?>
                    ...
                    <?php if(count($closeoutImages) > 0): ?>
                        <div style="margin-top: 8px; border-top: 1px dotted #ccc; padding-top: 6px; overflow: hidden;">
                            ...
                            <div class="photo-frame" style="min-height: 120px; max-height: 160px;">
                                <?php $__currentLoopData = $closeoutImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img src="<?php echo e($img); ?>" alt="Close-out Proof Photo" style="max-height: 120px; max-width: 98%;">
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div style="margin-top: 8px; border-top: 1px solid #000; padding-top: 6px;">
                        ...
                        <table class="no-border">
                            <tr>
                                <td class="no-border" width="50%">
                                    Name: <?php echo e($report->closeOutPerformer->name ?? '-'); ?>

                                </td>
                                <td class="no-border text-center">
                                    <?php if($report->close_out_at && $report->closeOutPerformer): ?>
                                        <div class="stamp-box" style="margin:0; border-color: #000; color: #000; background: #fff;">
                                            <strong>CLOSED</strong><br>
                                            <?php echo e($report->closeOutPerformer->name ?? '-'); ?><br>
                                            <span style="font-size: 6pt;"><?php echo e($report->closeOutPerformer->email); ?></span><br>
                                            <?php echo e(formatWita($report->close_out_at, 'd/M/Y H:i')); ?> WITA
                                        </div>
                                    <?php else: ?>
                                        Sign: ___________
                                    <?php endif; ?>
...
<?php /**PATH /home/kaptensa/salman/resources/views/cermat/pdf.blade.php ENDPATH**/ ?>