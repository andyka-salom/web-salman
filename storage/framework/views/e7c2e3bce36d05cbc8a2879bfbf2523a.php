...
<?php $__env->startSection('title', 'Review Laporan #' . $report->report_number); ?>
    ...
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-end mb-4">
            <div>
                ...
                <h2 class="fw-bold text-dark m-0">Laporan <span class="text-primary">#<?php echo e($report->report_number); ?></span></h2>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <!-- ============================================== -->
            <div class="col-12">
                <form action="<?php echo e(route('cermat.reports.submitReview', $report)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row g-4">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card-modern p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="radio-tile-group">
                                        <?php $__currentLoopData = ['Positive Aspect', 'Unsafe condition', 'Unsafe Action', 'Near Miss', 'Incident']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $val = Str::snake($class); ?>
                                            <input type="radio" class="radio-tile-input" name="classification"
                                                   id="class_<?php echo e(Str::slug($class)); ?>"
                                                   value="<?php echo e($val); ?>"
                                                   <?php echo e(old('classification', $report->classification) == $val ? 'checked' : ''); ?> required>
                                            <label class="radio-tile-label" for="class_<?php echo e(Str::slug($class)); ?>"><?php echo e($class); ?></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="event_type" value="hse" id="eventTypeHse" <?php echo e(old('event_type', $report->event_type ?? 'hse') == 'hse' ? 'checked' : ''); ?> onchange="toggleSecurityCategory()">
                                                <label class="form-check-label" for="eventTypeHse">HSE</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="event_type" value="security" id="eventTypeSecurity" <?php echo e(old('event_type', $report->event_type) == 'security' ? 'checked' : ''); ?> onchange="toggleSecurityCategory()">
                                    ...
                                    <div class="col-md-6 mb-3" id="securityCategoryContainer" style="display: none;">
                                        ...
                                        <select name="security_event_category_id" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $securityEventCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($cat->id); ?>"
                                                    <?php echo e(old('security_event_category_id', $report->security_event_category_id) == $cat->id ? 'selected' : ''); ?>>
                                                    <?php echo e($cat->name); ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0 risk-table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $consequences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="fw-bold text-dark ps-3"><?php echo e($label); ?></td>
                                                    <td>
                                                        <input type="number" name="initial_risk[<?php echo e($key); ?>][real_severity]"
                                                               class="form-control form-control-sm risk-input" min="0" max="5"
                                                               value="<?php echo e(old('initial_risk.'.$key.'.real_severity', $existingRisk->real_severity ?? '')); ?>">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="initial_risk[<?php echo e($key); ?>][potential_severity]"
                                                               class="form-control form-control-sm risk-input" min="0" max="5"
                                                               value="<?php echo e(old('initial_risk.'.$key.'.potential_severity', $existingRisk->potential_severity ?? '')); ?>">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="initial_risk[<?php echo e($key); ?>][likelihood]"
                                                               class="form-control form-control-sm risk-input" min="0" max="5"
                                                               value="<?php echo e(old('initial_risk.'.$key.'.likelihood', $existingRisk->likelihood ?? '')); ?>">
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                            ...
                            <div class="card-modern p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_term_mitigation" class="form-control" rows="3" placeholder="Jelaskan tindakan langsung... (Opsional)"><?php echo e(old('short_term_mitigation', $report->short_term_mitigation)); ?></textarea>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="pelanggaran_id" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $pelanggaranList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item->id); ?>" <?php echo e(old('pelanggaran_id', $report->pelanggaran_id) == $item->id ? 'selected' : ''); ?>><?php echo e($item->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label-fancy">P-horse.</label>
                                        <input type="text" name="synergi_register_no" class="form-control" value="<?php echo e(old('synergi_register_no', $report->synergi_register_no)); ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" name="cost_to_business_actual" class="form-control" step="0.01" value="<?php echo e(old('cost_to_business_actual', $report->cost_to_business_actual)); ?>">
                                            <span class="input-group-text">Potential</span>
                                            <input type="number" name="cost_to_business_potential" class="form-control" step="0.01" value="<?php echo e(old('cost_to_business_potential', $report->cost_to_business_potential)); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $consequences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    <td class="fw-bold text-dark ps-3"><?php echo e($label); ?></td>
                                                    <td>
                                                        <input type="number" name="residual_risk[<?php echo e($key); ?>][potential_severity]"
                                                               class="form-control form-control-sm risk-input" min="0" max="5"
                                                               value="<?php echo e(old('residual_risk.'.$key.'.potential_severity', $existingResidual->potential_severity ?? '')); ?>">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="residual_risk[<?php echo e($key); ?>][likelihood]"
                                                               class="form-control form-control-sm risk-input" min="0" max="5"
                                                               value="<?php echo e(old('residual_risk.'.$key.'.likelihood', $existingResidual->likelihood ?? '')); ?>">
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                        ...
                        <div class="col-lg-4">
                            <div class="position-sticky" style="top: 1rem; z-index: 10;">
                                ...
                                <div class="card-modern p-4 text-center bg-white border-primary">
                                    ...
                                    <a href="<?php echo e(route('cermat.reports.show', $report)); ?>" class="btn btn-link text-muted small text-decoration-none">Batal & Kembali</a>
                                </div>
                                ...
                                <div class="card-modern">
                                    ...
                                    <div class="p-3">
                                        <div class="mb-3">
                                            ...
                                            <p class="mb-0 fw-medium"><?php echo e($report->reporter->name); ?></p>
                                        </div>
                                        <div class="mb-3">
                                            <span class="text-uppercase text-muted" style="font-size: 0.7rem; font-weight: 700;">Waktu Kejadian</span>
                                            <p class="mb-0 fw-medium"><?php echo e($report->report_datetime->format('d M Y, H:i')); ?></p>
                                        </div>
                                        <div class="mb-3">
                                            <span class="text-uppercase text-muted" style="font-size: 0.7rem; font-weight: 700;">Uraian Singkat</span>
                                            <p class="mb-0 small text-muted bg-light p-2 rounded"><?php echo e(Str::limit($report->details, 200)); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row g-4 h-10">
                            ...
                            <?php if($actionItems->count() > 0): ?>
                                <div class="timeline-modern">
                                    <?php $__currentLoopData = $actionItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="timeline-modern-item status-<?php echo e(Str::slug($item->status)); ?>">
                                            <!-- Marker Status -->
                                            <div class="timeline-modern-marker">
                                                <?php if($item->status == \App\Models\ActionItem::STATUS_COMPLETED): ?> <i class="bi bi-check-lg"></i>
                                                <?php elseif($item->status == \App\Models\ActionItem::STATUS_CANT_DO): ?> <i class="bi bi-x"></i>
                                                <?php elseif($item->status == \App\Models\ActionItem::STATUS_IN_PROGRESS): ?> <i class="bi bi-arrow-repeat"></i>
                                                <?php else: ?> <i class="bi bi-clipboard"></i>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="timeline-modern-content">
                                                ...
                                                <div class="d-flex justify-content-between align-items-start mb-2">
                                                    ...
                                                    <span class="badge bg-light text-dark border py-2 px-3 fw-bold shadow-sm">
                                                        <?php echo e($item->actionCategory->name ?? 'General'); ?> (<?php echo e($item->actionCategory->code ?? 'GEN'); ?>)
                                                    </span>
                                                    ...
                                                    <div class="d-flex gap-1">
                                                        ...
                                                        <button type="button" class="btn-copy btn-copy-action"
                                                                ...
                                                                data-pic-id="<?php echo e($item->responsible_id); ?>"
                                                                data-date="<?php echo e($item->target_date ? $item->target_date->format('Y-m-d') : ''); ?>">
                                                            <i class="bi bi-files me-1"></i>Copy
                                                        </button>

                                                        <!-- Dropdown Menu -->
                                                        <?php if(!in_array($item->status, [\App\Models\ActionItem::STATUS_COMPLETED, \App\Models\ActionItem::STATUS_CANT_DO])): ?>
                                                            <div class="dropdown">
                                                                <button class="btn btn-sm btn-light border" type="button" data-bs-toggle="dropdown">
                                                                    <i class="bi bi-three-dots-vertical"></i>
                                                                </button>
                                                                <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                                                    <?php if($item->status === \App\Models\ActionItem::STATUS_DO): ?>
                                                                    <li>
                                                                        <form action="<?php echo e(route('cermat.action-items.updateStatus', $item)); ?>" method="POST">
                                                                            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                                                            <input type="hidden" name="status" value="<?php echo e(\App\Models\ActionItem::STATUS_IN_PROGRESS); ?>">
                                                                            <button type="submit" class="dropdown-item fw-medium"><i class="bi bi-play-circle-fill me-2 text-info"></i>Mulai Kerjakan</button>
                                                                        </form>
                                                                    </li>
                                                                    <?php endif; ?>
                                                                    <li><a class="dropdown-item text-success fw-medium" href="#" data-bs-toggle="modal" data-bs-target="#actionStatusModal-<?php echo e($item->id); ?>-completed"><i class="bi bi-check-circle-fill me-2"></i>Tandai Selesai</a></li>
                                                                    <li><a class="dropdown-item text-danger fw-medium" href="#" data-bs-toggle="modal" data-bs-target="#actionStatusModal-<?php echo e($item->id); ?>-cantdo"><i class="bi bi-x-circle-fill me-2"></i>Tidak Dikerjakan</a></li>
                                                                    <li><hr class="dropdown-divider"></li>
                                                                    <li><a class="dropdown-item text-primary fw-medium" href="#" data-bs-toggle="modal" data-bs-target="#extendTimeModal-<?php echo e($item->id); ?>"><i class="bi bi-calendar-plus-fill me-2"></i>Perpanjang Waktu</a></li>
                                                                </ul>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                                ...
                                                <!-- Body -->
                                                <p class="mb-2 text-dark fw-medium small lh-sm"><?php echo e(Str::limit($item->description, 100)); ?></p>

                                                <!-- Footer -->
                                                <div class="d-flex align-items-center gap-2 small text-muted border-top pt-2 mt-2">
                                                    <div class="rounded-circle bg-secondary text-white d-flex align-items-center justify-content-center" style="width:20px; height:20px; font-size:10px;"><?php echo e(substr($item->responsible->name ?? 'A', 0, 1)); ?></div>
                                                    <span class="text-truncate" style="max-width: 100px;"><?php echo e($item->responsible->name ?? '-'); ?></span>
                                                    <?php if($item->target_date): ?>
                                                        <span class="ms-auto <?php echo e($item->target_date->isPast() && $item->status != 'completed' ? 'text-danger fw-bold' : ''); ?>">
                                                            <?php echo e($item->target_date->format('d M y')); ?>
                                                ...
                                                <!-- Extra Info -->
                                                <?php if(in_array($item->status, [\App\Models\ActionItem::STATUS_COMPLETED, \App\Models\ActionItem::STATUS_CANT_DO]) && $item->completion_notes): ?>
                                                    <div class="completion-notes mt-2">
                                                        <strong class="d-block text-uppercase" style="font-size: 0.7rem;">Catatan:</strong>
                                                        "<?php echo e($item->completion_notes); ?>"
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade" id="actionStatusModal-<?php echo e($item->id); ?>-completed" tabindex="-1" aria-hidden="true">
                                            
                                            <div class="modal-dialog modal-dialog-centered">
                                                <form action="<?php echo e(route('cermat.action-items.updateStatus', $item)); ?>" method="POST" enctype="multipart/form-data">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                                    <input type="hidden" name="status" value="<?php echo e(\App\Models\ActionItem::STATUS_COMPLETED); ?>">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="file-upload-wrapper" id="upload-wrapper-<?php echo e($item->id); ?>">
                                                                    <input type="file" name="proof_photos[]" class="proof-photo-input" accept="image/*" multiple data-item-id="<?php echo e($item->id); ?>">
                                                                ...
                                                                <div class="file-preview-container" id="preview-<?php echo e($item->id); ?>"></div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="modal fade" id="actionStatusModal-<?php echo e($item->id); ?>-cantdo" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <form action="<?php echo e(route('cermat.action-items.updateStatus', $item)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                                    <input type="hidden" name="status" value="<?php echo e(\App\Models\ActionItem::STATUS_CANT_DO); ?>">
                                                    <div class="modal-content">
                                        ...
                                        <div class="modal fade" id="extendTimeModal-<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <form action="<?php echo e(route('cermat.action-items.extend', $item)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="date" class="form-control" name="new_target_date" min="<?php echo e(now()->toDateString()); ?>" required>
                                                            </div>
                                                            <div>
                    ...
                    <div class="col-lg-7">
                        <div class="draft-area d-flex flex-column">
                            ...
                            <form action="<?php echo e(route('cermat.reports.bulkAddActionItems', $report)); ?>" method="POST" id="bulkActionForm" class="flex-grow-1 d-flex flex-column">
                                <?php echo csrf_field(); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const actionCategoryMap = <?php echo json_encode($jsActionCategories, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/cermat/review.blade.php ENDPATH**/ ?>