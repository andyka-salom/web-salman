<?php $__env->startSection('title', 'Action Categories'); ?>
...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            <div class="col-md-6">
                <h3 class="m-0 fw-bold">Action Categories</h3>
            </div>
            <div class="col-md-6 text-md-end mt-3 mt-md-0 page-title-action">
                <a href="<?php echo e(route('action-categories.create')); ?>" class="btn btn-primary">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-8">
                <div class="table-responsive">
                    <table id="category-table" class="table dt-table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th width="5%">No</th>
                                <th width="15%">Code</th>
...
$(document).ready(function() {
    ...
    const table = $('#category-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('action-categories.index')); ?>",
            data: function(d) {
        ...
        columns: [
            ...
            { data: 'code', name: 'code' },
            { data: 'name', name: 'name' },
            { data: 'duration_range', name: 'duration_range' },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/action-categories/index.blade.php ENDPATH**/ ?>