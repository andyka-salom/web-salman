<?php $__env->startSection('title', 'Unsafe Acts Management'); ?>
    ...
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-top-spacing mb-4 align-items-center">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0 page-title-action">
                <a href="<?php echo e(route('unsafe-acts.create')); ?>" class="btn btn-primary">
        ...
        <div class="row layout-spacing">
            ...
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mb-4">
                <div class="stats-card text-center">
                    <h3 class="mb-1 text-success fw-bold"><?php echo e($stats['active']); ?></h3>
                    <p class="text-muted mb-0 font-monospace">Active</p>
                </div>
            </div>
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mb-4">
                <div class="stats-card text-center">
                    <h3 class="mb-1 text-danger fw-bold"><?php echo e($stats['inactive']); ?></h3>
                    <p class="text-muted mb-0 font-monospace">Inactive</p>
                </div>
            </div>
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mb-4">
                <div class="stats-card text-center">
                    <h3 class="mb-1 text-info fw-bold"><?php echo e($stats['used']); ?></h3>
                    <p class="text-muted mb-0 font-monospace">Used</p>
                </div>
            </div>
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mb-4">
                <div class="stats-card text-center">
                    <h3 class="mb-1 text-warning fw-bold"><?php echo e($stats['never_used']); ?></h3>
                    <p class="text-muted mb-0 font-monospace">Never Used</p>
                </div>
            </div>
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 mb-4">
                <div class="stats-card text-center">
                    <h3 class="mb-1 text-primary fw-bold"><?php echo e(number_format($stats['total_usage'])); ?></h3>
...
$(document).ready(function() {
    ...
    const table = $('#unsafe-acts-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('unsafe-acts.index')); ?>",
            data: function(d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/master/unsafe-acts/index.blade.php ENDPATH**/ ?>