<?php $__env->startSection('title', 'Broadcast Manual'); ?>
...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        <form action="<?php echo e(route('broadcast.send.manual')); ?>" method="POST" enctype="multipart/form-data" id="broadcastForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="title" name="title" value="<?php echo e(old('title')); ?>" placeholder="Contoh: Info Promo Desember">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control <?php $__errorArgs = ['phone_numbers'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="phone_numbers" name="phone_numbers" rows="5" placeholder="081234567890&#10;628123456789&#10;089876543210" required><?php echo e(old('phone_numbers')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="message" name="message" rows="8" placeholder="Tulis pesan Anda di sini..." required><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="scheduled_at" name="scheduled_at" value="<?php echo e(old('scheduled_at')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <a href="<?php echo e(route('broadcast.index')); ?>" class="btn btn-outline-secondary">
...
<script src="<?php echo e(asset('plugins/src/filepond/FilePondPluginImageCrop.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/src/filepond/FilePondPluginImageResize.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/src/filepond/FilePondPluginImageTransform.min.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kaptensa/salman/resources/views/broadcast/create-manual.blade.php ENDPATH**/ ?>